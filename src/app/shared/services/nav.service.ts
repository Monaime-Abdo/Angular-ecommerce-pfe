...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{
			title: 'home', type: 'link', active: false,path: '/'
		},
		{
			title: 'Shop', type: 'link', active: false,path: '/shop/collection/left/sidebar'
		},
		{
			title: 'Collection', type: 'sub', badgeText: 'new',badge: true, active: false, children: [
				{
					title: 'For men', type: 'sub', active: false, children: [
						{ path: '/shop/product/left/sidebar/trim-dress', title: '9wamj', type: 'link' },
						{ path: '/shop/product/left/sidebar/trim-dress', title: 'slipate', type: 'link' },
					]
				},
				{
					title: 'For women', type: 'sub', active: false, children: [
						{ path: '/shop/product/left/sidebar/trim-dress', title: 'soutiyamate', type: 'link' },
						{ path: '/shop/product/left/sidebar/trim-dress', title: 'stringates', type: 'link' },
		...
		{ path: '/pages/login', title: 'login | register', type: 'link' },			
